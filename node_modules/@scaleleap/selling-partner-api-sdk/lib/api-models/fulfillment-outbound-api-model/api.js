...
const FbaOutboundApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listReturnReasonCodes: async (sellerSku, language, marketplaceId, sellerFulfillmentOrderId, options = {}) => {
            // verify required parameter 'sellerSku' is not null or undefined
...
const FbaOutboundApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listReturnReasonCodes(sellerSku, language, marketplaceId, sellerFulfillmentOrderId, options) {
