...
/**
    ...
    * @enum {string}
    */
export declare enum LabelDataLabelFormatEnum {
    Pdf = "PDF"
}
/**
 * Location identifier.
...
/**
    ...
    * @enum {string}
    */
export declare enum PackedQuantityUnitOfMeasureEnum {
    Cases = "Cases",
    Eaches = "Eaches"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum ShipmentInformationShipModeEnum {
    SmallParcel = "SmallParcel",
    Ltl = "LTL"
}
/**
...
export declare const VendorShippingApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getShipmentLabels: (limit?: number, sortOrder?: 'ASC' | 'DESC', nextToken?: string, labelCreatedAfter?: string, labelcreatedBefore?: string, buyerReferenceNumber?: string, vendorShipmentIdentifier?: string, sellerWarehouseCode?: string, options?: any) => Promise<RequestArgs>;
    /**
...
export declare const VendorShippingApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getShipmentLabels(limit?: number, sortOrder?: 'ASC' | 'DESC', nextToken?: string, labelCreatedAfter?: string, labelcreatedBefore?: string, buyerReferenceNumber?: string, vendorShipmentIdentifier?: string, sellerWarehouseCode?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetShipmentLabels>>;
    /**
     * Submits one or more shipment confirmations for vendor orders.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 10 | 10 |  The `x-amzn-RateLimit-Limit` response header returns the usage plan rate limits that were applied to the requested operation, when available. The table above indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may see higher rate and burst values than those shown here. For more information, see [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
     * @param {SubmitShipmentConfirmationsRequest} body
     * @param {*} [options] Override http request option.
...
export declare class VendorShippingApi extends BaseAPI {
     ...
     * @memberof VendorShippingApi
     */
    getShipmentLabels(requestParameters?: VendorShippingApiGetShipmentLabelsRequest, options?: any): Promise<import("axios").AxiosResponse<GetShipmentLabels, any>>;
    /**
     * Submits one or more shipment confirmations for vendor orders.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 10 | 10 |  The `x-amzn-RateLimit-Limit` response header returns the usage plan rate limits that were applied to the requested operation, when available. The table above indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may see higher rate and burst values than those shown here. For more information, see [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
