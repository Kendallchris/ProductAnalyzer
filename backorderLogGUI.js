...
async function startProcess() {
    try {
        ...
        await getTokenAndMakeApiCall(); // This gets the initial token
        calculateProfits();
        filterAndWriteToCSV();
    } catch (error) {
...
async function startBackorderAnalysis(filePath) {
