...
/**
    ...
    * @enum {string}
    */
var LabelDataLabelFormatEnum;
(function (LabelDataLabelFormatEnum) {
    LabelDataLabelFormatEnum["Pdf"] = "PDF";
})(LabelDataLabelFormatEnum || (exports.LabelDataLabelFormatEnum = LabelDataLabelFormatEnum = {}));
/**
    * @export
    * @enum {string}
    */
var PackedQuantityUnitOfMeasureEnum;
(function (PackedQuantityUnitOfMeasureEnum) {
    PackedQuantityUnitOfMeasureEnum["Cases"] = "Cases";
    PackedQuantityUnitOfMeasureEnum["Eaches"] = "Eaches";
})(PackedQuantityUnitOfMeasureEnum || (exports.PackedQuantityUnitOfMeasureEnum = PackedQuantityUnitOfMeasureEnum = {}));
/**
    * @export
    * @enum {string}
    */
...
/**
    ...
    * @enum {string}
    */
var ShipmentInformationShipModeEnum;
(function (ShipmentInformationShipModeEnum) {
    ShipmentInformationShipModeEnum["SmallParcel"] = "SmallParcel";
    ShipmentInformationShipModeEnum["Ltl"] = "LTL";
})(ShipmentInformationShipModeEnum || (exports.ShipmentInformationShipModeEnum = ShipmentInformationShipModeEnum = {}));
/**
    * @export
    * @enum {string}
    */
...
const VendorShippingApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getShipmentLabels(limit, sortOrder, nextToken, labelCreatedAfter, labelcreatedBefore, buyerReferenceNumber, vendorShipmentIdentifier, sellerWarehouseCode, options) {
